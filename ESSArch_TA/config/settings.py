...
EMAIL_PORT = 25
#EMAIL_USE_TLS = False
SERVER_EMAIL = 'ETA@localhost' # from 
DEFAULT_FROM_EMAIL = 'ETA_Default@localhost'
...
if DEV:
    TEMPLATE_DIRS = "/ESSArch_Tools_Archive/templates" 		# development
else:
...
LOGGING = {
    ...
    'handlers': {
        ...
        'log_file': {
            ...
            'formatter': 'verbose',
            'filename': '/ESSArch/eta/log/eta.log',
        ...
        'debug_file': {
            ...
            #'class': 'logging.FileHandler',
            'formatter': 'verbose',
            'filename': '/ESSArch/eta/log/debug/eta_debug.log',
            'maxBytes': 1024*1024*5, # 5MB
            'backupCount': 5,
        },
    },
