...
#DEV = True  # development and testing
DEV = False # production
DEBUG = True  # only in development and testing
...
if DEV:
    DATABASES = {
        'default': {
            ...
            'NAME': '/home/bms/workspace/ESSArch_Tools/tools.db',  # development path to database file if using sqlite3.
    ...
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
            'NAME': '/ESSArch/Tools/tools.db',      # production path to database file if using sqlite3.
            'USER': '',                             # Not used with sqlite3.
            'PASSWORD': '',                         # Not used with sqlite3.
            'HOST': '',                             # Set to empty string for localhost. Not used with sqlite3.
            'PORT': '',                             # Set to empty string for default. Not used with sqlite3.
...
EMAIL_PORT = 25
#EMAIL_USE_TLS = False
SERVER_EMAIL = 'ESSArch_Tools@localhost' # from 
DEFAULT_FROM_EMAIL = 'ESSArch_Tools_Default@localhost'
...
if DEV:
    STATICFILES_DIRS = (
    "/home/bms/workspace/ESSArch_Tools/static", # development
    )
else:
    STATICFILES_DIRS = (
    "/ESSArch/Tools/static", # production
    )
...
if DEV:
    TEMPLATE_DIRS = (
    "/home/bms/workspace/ESSArch_Tools/templates" # development
    )
else:
    TEMPLATE_DIRS = (
    "/ESSArch/Tools/templates" # production
    )
...
LOGGING = {
    ...
    'handlers': {
        ...
        'log_file': {
            ...
            'formatter': 'verbose',
            'filename': '/ESSArch/log/Tools.log',
        ...
        'debug_file': {
            ...
            #'class': 'logging.FileHandler',
            'formatter': 'verbose',
            'filename': '/ESSArch/log/debug/Tools_debug.log',
            'maxBytes': 1024*1024*5, # 5MB
            'backupCount': 5,
        },
    },
