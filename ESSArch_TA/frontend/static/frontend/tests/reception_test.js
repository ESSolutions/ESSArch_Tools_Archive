...
describe('ReceptionCtrl', function() {
    ...
    describe('IP table', function() {
        var $scope, controller, row;
        ...
        describe('$scope.ipTableClick', function() {
            it('row exists', function() {
                expect(row).not.toBe(null);
            });

            it('$scope.ip is set to row', function() {
                $scope.ipTableClick(row);
                expect($scope.ip.id).toBe("b76e97e8-2896-47a5-87df-da740dff7535");
            });
        });
    });
});
