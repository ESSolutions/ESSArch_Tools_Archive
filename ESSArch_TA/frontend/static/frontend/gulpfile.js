...
var buildPolyfills = function() {
  return gulp
    .src(jsPolyfillFiles, {allowEmpty: true, sourcemaps: true})
    .pipe(
...
var buildCoreTemplates = function() {
  return gulp
    .src(coreHtmlFiles, {allowEmpty: true})
    .pipe(
      templateCache({
        standalone: true,
...
var buildCoreScripts = function() {
  return gulp
    .src(coreJsFiles, {allowEmpty: true, sourcemaps: true})
...
var buildCoreTests = function() {
  return gulp
    .src(coreTestFiles, {allowEmpty: true})
...
var buildScripts = function() {
  return gulp
    .src(jsFiles, {allowEmpty: true, sourcemaps: true})
    .pipe(
      plumber(function(error) {
        // output an error message
...
var buildVendors = function() {
  return gulp
    .src(jsVendorFiles, {allowEmpty: true, sourcemaps: true})
    .pipe(
      plumber(function(error) {
        // output an error message
...
var compileSass = function() {
  return gulp
    .src('styles/styles.scss', {allowEmpty: true, sourcemaps: true})
  ...
  return gulp
    .src(
      [
        ...
        'scripts/polyfills.min.js.map',
        'scripts/vendors.min.js',
        'scripts/vendors.min.js.map',
      ],
      {allowEmpty: true}
    )
...
var copyImages = function() {
  return gulp
    .src('node_modules/angular-tree-control/images/**.*', {allowEmpty: true})
