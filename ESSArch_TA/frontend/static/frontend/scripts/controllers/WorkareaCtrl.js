...
angular.module('essarch.controllers').controller('WorkareaCtrl', function(vm, ipSortString, IP, $http, $scope, $rootScope, $state, $log, listViewService, Resource, $translate, $interval, $uibModal, appConfig, $timeout, $anchorScroll, PermPermissionStore, $cookies, $controller, $sce, $window, Notifications, $filter,  $q) {
