angular.module('myApp').controller('ProfileCtrl', function($q, SA, IP, Profile, $timeout, ProfileIp, ProfileIpData, $scope, $http, $rootScope, appConfig, listViewService, $log, $uibModal, $translate, $filter, IPReception) {
    var vm = this;
    $scope.angular = angular;
    $scope.select = true;
    $scope.alerts = {
        receiveError: { type: 'danger', msg: $translate.instant('CANNOT_RECEIVE_ERROR') },
        tpError: { type: 'danger', msg: $translate.instant('MISSING_TRANSFER_PROJECT') },
