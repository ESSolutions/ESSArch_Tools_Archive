...
# -*- coding: utf-8 -*-
#
# ESSArch Tools Archive documentation build configuration file, created by
...
project = u'ESSArch Tools Archive'
...
htmlhelp_basename = 'ESSArchToolsArchivedoc'
...
latex_documents = [
    (master_doc, 'ESSArchToolsArchive.tex', u'ESSArch Tools Archive Documentation',
...
man_pages = [
    (master_doc, 'essarchtoolsarchive', u'ESSArch Tools Archive Documentation',
     [author], 1)
]
