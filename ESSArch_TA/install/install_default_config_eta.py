...
zone = "zone2" # ETP=zone1, ETA=zone2
...
def installdefaultparameters(): # default config parameters
    ...
    if site_profile == "SE" :
        dct = {
             ...
             'preservation_organization_receiver':'False, example: http://xxx.xxx.xxx.xxx:5001,user,pass',
...
def createdefaultusers(): # default users, groups and permissions
    ...
    try:
        ...
        myuser = User.objects.create_user('usr2', 'usr2@ETA', 'usr2')
...
def installdefaultpaths(): # default paths
    ...
    # create dictionary for zone
    dct = {
          'path_definitions':'/ESSArch/eta/env',
...
def installdefaultschemaprofiles(): # default schema profiles for Sweden and Norway
    ...
    # create schema dictionary per country SE/NO 
    if site_profile == "SE" :
        dct = {
